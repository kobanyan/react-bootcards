...
import {Card, CardHeader, CardTitle, CardFooter, ListGroupItemHeader, ListGroupItemText} from 'react-bootcards';
  ...
  render () {
    return (
      <Section id="doc-filecard">
        <h3>File Cards</h3>
        <p className="lead">File Cards are intended to show information and functions for non-media file formats (PDFs, Word documents, spreadsheets, etc).</p>
        <Example>
          <Card cardStyle="file">
            <CardHeader>
