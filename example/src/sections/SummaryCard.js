...
import {Card, CardHeader, CardTitle, CardFooter, SummaryItem} from 'react-bootcards';
  ...
  render() {
    return (
      <Section id="doc-summarycard">
        <h3>Summary Cards</h3>
        <p className="lead">Summary cards can be used on dashboards, etc to highlight important pieces of data in your app.</p>
        <Example>
