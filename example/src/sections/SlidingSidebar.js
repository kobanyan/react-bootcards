  ...
  render() {
    return (
      <Section id="doc-slidingsidebar">
        ...
        <p className="lead">The Sliding Sidebar offers complex apps more space navigation items.</p>
        ...
        <p>Bootcards tries to find the element that has <code>data-toggle="offcanvas"</code> and attaches a handler to show/ hide the menu.</p>
        <li>The menu:</li>
        <p />
        <Highlight>
